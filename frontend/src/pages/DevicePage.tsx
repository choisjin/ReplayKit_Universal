            ...
            {(editDevice.type === 'isap_agent' || editDevice.type === 'adb')
              ...
              <div style={{ border: '1px solid #f0f0f0', borderRadius: 6, padding: '8px 10px' }}>
                ...
                <Space direction="vertical" style={{ width: '100%' }} size={6}>
                  ...
                  <div>
                    <Checkbox
                      checked={editExtraFields.webos_overlay_android === true}
                      onChange={(e) => setEditExtraFields({ ...editExtraFields, webos_overlay_android: e.target.checked })}
                    >
                      <span style={{ fontSize: 12 }}>Android UI 합성해서 보기</span>
                    </Checkbox>
                    <InputNumber
